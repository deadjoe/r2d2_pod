...
const UA = "r2d2-pod/0.1 (+https://github.com/deadjoe/r2d2_pod)";
const REST = "https://rest.runpod.io/v1";
const GQL = "https://api.runpod.io/graphql";
export const APP_PORT = 8765;
...
// The image's llama-server is compiled for Turing (sm_75) and newer; older cards (Volta,
// Pascal, Kepler, Maxwell) cannot run it. MIG slices are not accepted as gpuTypeIds.
const UNSUPPORTED = /V100|P100|P40|\bP4\b|P6000|Quadro P|K80|M60|GTX 10|MIG/i;
...
/** Cards the image runs on, in stock, within the price ceiling, cheapest first. */
 ...
 *  REST's runtimeStatus stays null on a running pod, so this is the reliable boot signal. */
...
export function proxyUrl(podId: string, port = APP_PORT): string {
